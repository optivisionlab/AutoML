...
def render_training_in_progress_html(metric_sort: str = "accuracy") -> str:
    """
    ...
    <div class="champion-card" style="border-color: #818cf8; background: linear-gradient(135deg, rgba(99, 102, 241, 0.06) 0%, rgba(168, 85, 247, 0.06) 100%);">
        ...
        <div style="padding: 20px 0; text-align: center; color: #64748b; font-size: 14px;">
            <div style="display: inline-block; margin-bottom: 6px; font-weight: 500;">⚡ Parallel Model Training & 3-Tier Cross-Validation across CPU worker threads...</div>
            <div style="font-size: 12px; color: #94a3b8;">Models being tuned: LogisticRegression, RandomForest, DecisionTree, SVC, GaussianNB, KNeighbors</div>
        </div>
    </div>
    """
...
def render_dataset_overview_html(
    ...
    <div class="dataset-card">
        <div class="dataset-card-header">
            ...
            <span class="dataset-type-badge">Classification</span>
        </div>
...
def render_champion_card_html(
    ...
    # Format metric cards (Accuracy, Precision, Recall, F1)
    ...
    <div class="champion-card">
        <div class="champion-header">
            <div class="champion-title-wrap">
                <span class="champion-tag">BEST PERFORMING MODEL</span>
