...
# Auto-discover thêm các strategy trong thư mục strategies
SearchStrategyFactory.discover_strategies()

# Export các thành phần chính
__all__ = ['SearchStrategy', 'SearchStrategyFactory', 'GridSearchStrategy']