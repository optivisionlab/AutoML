            ...
            <Table className="automl-data-table">
              ...
              <TableBody>
                {paginatedJobs.map((job) => {
                  ...
                  return (
                    <TableRow key={job._id} className={isDone ? "automl-row-highlight" : undefined}>
                      ...
                      <TableCell>
                        <div className="space-y-2">
                          <Badge
                            variant="outline"
                            className={`${isDone ? "automl-status-success" : "automl-status-warning"} rounded-full px-3 py-1`}
                          >
